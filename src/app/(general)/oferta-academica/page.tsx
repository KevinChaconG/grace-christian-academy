...
<div className="container mb-5 oferta-academica">
  ...
  <div className="row">
    ...
    <div className="col-md-6 mb-4">
      <div className="card shadow h-100 nivel-card">
        <div className="card-body fs-6 fs-md-5">
          ...
          <p className="texto-nivel">
            Etapa donde los estudiantes fortalecen las bases académicas y forman hábitos de estudio saludables.
          </p>
          ...
          <div className="nivel-seccion">
            ...
            <ul>
              ...
              <li>Trabajo en equipo y responsabilidad personal.</li>
            </ul>
          </div>
          ...
          <div className="nivel-seccion">
            ...
            <ul>
              ...
              <li>Matemáticas y Ciencias Naturales.</li>
              <li>Estudios Sociales y Arte.</li>
            </ul>
          </div>
          ...
          <div className="nivel-seccion">
            <h5 className="titulo-seccion">Inglés</h5>
            <ul>
              <li>Lectura y comprensión de textos sencillos.</li>
              <li>Escritura de párrafos básicos.</li>
              <li>Práctica de speaking en actividades diarias.</li>
            </ul>
          </div>
          ...
          <div className="nivel-seccion">
            <h5 className="titulo-seccion">Valores cristianos</h5>
            <ul>
              <li>Aplicación de principios bíblicos en la convivencia.</li>
              <li>Respeto por autoridades, compañeros y familia.</li>
            </ul>
          </div>
          ...
          <div className="nivel-seccion">
            <h5 className="titulo-seccion">Actividades especiales</h5>
            <ul>
              <li>Proyectos de aula y ferias de lectura.</li>
              <li>Actos cívicos y devocionales.</li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <div className="col-md-6 mb-4">
      <div className="card shadow h-100 nivel-card">
        <div className="card-body fs-6 fs-md-5">
          <h3 className="text-danger mb-3">Bachillerato Ciencias y Humanidades</h3>

          <p className="texto-nivel">
            Preparación académica avanzada para la universidad y la vida profesional, con un enfoque en liderazgo y servicio.
          </p>

          <div className="nivel-seccion">
            <h5 className="titulo-seccion">Habilidades desarrolladas</h5>
            <ul>
              <li>Pensamiento analítico y toma de decisiones.</li>
              <li>Gestión de proyectos y trabajo colaborativo.</li>
              <li>Comunicación efectiva en contextos formales.</li>
            </ul>
          </div>

          <div className="nivel-seccion">
            <h5 className="titulo-seccion">Enfoque académico</h5>
            <ul>
              <li>Ciencias: Biología, Química, Física y Matemáticas avanzadas.</li>
              <li>Letras: Literatura, Comunicación y Ciencias Sociales.</li>
              <li>Asignaturas de formación general y electivas.</li>
            </ul>
          </div>
          ...
          <div className="nivel-seccion">
            <h5 className="titulo-seccion">Inglés</h5>
            <ul>
              <li>Producción de ensayos y presentaciones académicas.</li>
          ...
          <div className="nivel-seccion">
            <h5 className="titulo-seccion">Valores cristianos</h5>
            <ul>
              <li>Liderazgo con enfoque en servicio.</li>
          ...
          <div className="nivel-seccion">
            <h5 className="titulo-seccion">Actividades especiales</h5>
            <ul>
              <li>Proyectos de investigación y exposiciones finales.</li>
              <li>Orientación vocacional y acompañamiento para la elección de carrera.</li>
            </ul>
          </div>
        </div>
      </div>
